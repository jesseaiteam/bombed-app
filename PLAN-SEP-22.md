...
Sep 22, 2026 · Jesse Salas · Claude implementation pack

NOTION NOTE: Connector still needs re-auth. This repo + Google Drive is the archive.
...
TRAILER GUY: That's a stall wearing a founder jacket. The plan isn't the joke. The cowardice is.
FIX 1: I wrote eleven plans for a club that lives in my phone so I wouldn't have to walk into a real one.
FIX 2: I keep drafting the autopsy instead of dying onstage. The docs are funnier than me and they don't drink.
TAG: Notion's locked. The room isn't. I picked the lock that talks back.
BUTTON: Monday still wants a body, not a spec.
VERDICT: You died because you pitched the homework instead of roasting the guy hiding in it.
